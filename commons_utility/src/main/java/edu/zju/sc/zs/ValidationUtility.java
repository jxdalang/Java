...
/**
 * This is a utility class that provides static methods for checking
 * whether some arbitrary value meets specific criteria
 * (not null, not empty, positive, negative, etc).
 * If criteria is not met, this utility throws an exception of type specified by the caller.
 *
 * Thread Safety:
...
public class ValidationUtility {
    ...
    /**
     * Checks whether the given File instance points to an existing file or directory.
     * And if this condition is not met, the specified exception is thrown.
    ...
    /**
     * Checks whether the given File instance points to an existing file.
     * And if this condition is not met, the specified exception is thrown.
     * Note that if file is null, exception is not thrown.
     *
    ...
    /**
     * Checks whether the given map value is not empty.
     * And if this condition is not met, the specified exception is thrown.
    ...
    /**
     * Checks whether the given collection doesn't contain null elements.
     * And if this condition is not met, the specified exception is thrown.
     * Note that if collection is null, exception is not thrown.
     *
     ...
     * (strings, collections, maps). And if this condition is not met,
    ...
    /**
     * Checks whether the given map doesn't contain a null key.
     * And if this condition is not met, the specified exception is thrown.
     * Note that if map is null, exception is not thrown.
     *
    ...
    /**
     * Checks whether the given map doesn't contain a null value.
     * And if this condition is not met, the specified exception is thrown.
     * Note that if map is null, exception is not thrown.
     *
    ...
    /**
     * Checks whether the given map doesn't contain empty keys (strings, collection, maps).
     * And if this condition is not met, the specified exception is thrown.
     * Note that if map is null, exception is not thrown.
     *
    ...
    /**
     * Checks whether the given map doesn't contain empty values (strings, collection, maps).
     * And if this condition is not met, the specified exception is thrown.
     * Note that if map is null, exception is not thrown.
     *
