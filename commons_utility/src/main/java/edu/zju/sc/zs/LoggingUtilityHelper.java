...
/**
 * This is a static helper class that provides log message generation functionality
 * for LoggingWrapperUtility and Log4jUtility.
 *
 * Thread Safety:
...
class LoggingUtilityHelper {
    ...
    /**
     * Retrieves the log message for the given input parameters.
