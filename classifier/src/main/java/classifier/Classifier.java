...
public class Classifier {
    ...
    private final String TRAIN_PATH = "train_data.json";
    private final String TEST_PATH = "test_data.json";
    ...
    private void crawlWebData() {
        ...
        crawlerController.work("http://tech.163.com/", 50);
        crawlerController.work("http://news.163.com/", 50);
        crawlerController.work("http://edu.163.com/", 50);
    ...
    public void buildTrainSet() {
        for (WebEntity web : trainData) {
            ...
            for (String word : web.getWordCount().keySet()) {
                if (word.contains("科技") || word.contains("体育")
                        || word.contains("教育") || word.contains("网易")) {
                    continue;
                }
